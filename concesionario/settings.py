...
DATABASES = {
    'default': {
        ...
        'NAME': '/Users/jhon/Python/concesionario/concesionario/basedatos.sqlite',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'yv0t1l4$ri0kq0kmct*--+rnd(3v2t5yc96d_csb@_^sxvdkj1'
